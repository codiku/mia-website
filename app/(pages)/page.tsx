  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900 relative">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link
          className="flex items-center justify-center no-underline gap-4"
          href="#"
        >
      ...
      <main className="flex-1">
        ...
        <div className="flex justify-center 2xl:absolute top-24 right-6  ">
          <a
            href="https://drive.usercontent.google.com/download?id=1rvR7Ww7RcR7ESWAO7rnFcCvx4zHj6eGb&export=download&authuser=0&confirm=t&uuid=cea8f42e-6c6f-42ba-9134-c84eef0d1c10&at=AN_67v3plsqABEykUYie3cjVPSX8%3A1728922027854"
